...
const Project = () => {
  return (
    <>
      ...
      <aside className="text-xs mr-4 text-gray-500 text-justify font-bold leading-relaxed col-span-5 lg:col-auto">
        <p>
      ...
      <article className="col-span-5 lg:col-span-4 grid sm:grid-cols-2 md:grid-cols-3 gap-4">
